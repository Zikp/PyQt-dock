...
from PyQt5.QtWidgets import (QCalendarWidget, QFileSystemModel, QFrame, QLabel,
                             ...
                             QComboBox, QStyle, QSizePolicy, QInputDialog, QMainWindow)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.perspective_combo_box.activated.connect(self.open_perspective_combox)
    ...
    def open_perspective_combox(self, i):
        name = self.perspective_combo_box.itemText(i)
        self.dock_manager.open_perspective(name)
    ...
    def save_perspective(self, *_, **__):
        perspective_name = QInputDialog.getText(self, 'Save perspective', 'Enter unique name:')[0]
        if perspective_name:
