...
from PyQt5.QtCore import QEvent, QSize, QXmlStreamWriter, Qt, pyqtSignal
from PyQt5.QtGui import QIcon
from PyQt5.QtWidgets import (QAction, QBoxLayout, QFrame, QScrollArea,
                             QSplitter, QToolBar, QWidget)

from qtpydocking.enums import (DockWidgetFeature, WidgetState, ToggleViewActionMode,
                               InsertMode)
from qtpydocking.util import find_parent, emit_top_level_event_for_widget

if TYPE_CHECKING:
    from qtpydocking import DockAreaWidget, DockManager, DockWidgetTab
...
class DockWidget(QFrame):
    ...
    # false.
    top_level_changed = pyqtSignal(bool)
    ...
    def flag_as_unassigned(self):
        ...
        '''
        self.d.closed = True
        logger.debug(f'flag_as_unassigned {self} -> setParent {self.d.dock_manager}'
                     )
        ...
        logger.debug(f'flag_as_unassigned {tab_widget} -> setParent {self}'
                     )
