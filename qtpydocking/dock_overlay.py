...
from PyQt5.QtCore import (QEvent, QPoint, QPointF, QRect, Qt, QSizeF, QRectF,
                          QLineF)
from PyQt5.QtGui import (QColor, QCursor, QHideEvent, QPaintEvent, QPainter,
                         QPalette, QShowEvent, QPixmap, QPolygonF)
from PyQt5.QtWidgets import QFrame, QWidget, QLabel, QGridLayout

from qtpydocking.enums import OverlayMode, DockWidgetArea, IconColor, area_alignment
# from qtpydocking.dock_area_widget import DockAreaWidget
from qtpydocking.dock_container_widget import DockAreaWidget
