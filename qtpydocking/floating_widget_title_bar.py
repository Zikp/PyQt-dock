...
from PyQt5.QtWidgets import QBoxLayout, QSizePolicy, QStyle, QPushButton, QLabel, QWidget
...
if TYPE_CHECKING:
    from qtpydocking import FloatingDockContainer
...
class FloatingWidgetTitleBar(QWidget):
    ...
    def mouseReleaseEvent(self, ev: QMouseEvent):
        logger.debug(f'FloatingWidgetTitleBar.mouseReleaseEvent')
