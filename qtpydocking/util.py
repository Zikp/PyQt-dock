...
from PyQt5.QtCore import Qt, QEvent, QObject, QRegExp
from PyQt5.QtGui import QPainter, QPixmap, QIcon
from PyQt5.QtWidgets import QApplication, QStyle, QAbstractButton
...
QT_VERSION_TUPLE = tuple(int(i) for i in QT_VERSION_STR.split('.')[:3])
