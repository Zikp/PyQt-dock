...
from qtpydocking.enums import DockFlags, DragState, DockWidgetFeature, TitleBarButton
from qtpydocking.util import set_button_icon

if TYPE_CHECKING:
    from qtpydocking import DockAreaWidget, DockAreaTabBar, DockManager
...
class DockAreaTitleBar(QFrame):
    ...
    def on_close_button_clicked(self):
        logger.debug(f'DockAreaTitleBar.onCloseButtonClicked')
